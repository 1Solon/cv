...
\title{Saul Burgess -- CV} % Print the main header
...
\parbox{0.5\textwidth}{ % First block
    \begin{tabbing} % Enables tabbing
        ...
        \> Rochestown Avenue, Co. Dublin \\ % Address line 2
...
\interestsgroup{
    \interest{Represented TUD in Games Fleadh 2020, a java based Artificial Intelligence challenge ‘Robocode’
        in March 2020, having designed and written ‘Oberon’, a decision tree based, linear targeting virtual tank.}
    \\
    ...
    \\
    \interest{Skilled Public Speaker – won second place in the
        Trinity Classics Oratory competition for three consecutive years.}
    \\
    \interest{Accomplished Sailor, having achieved my Royal Yachting Association
